...
* 9/3/20 lgk kahn@lgk.com port to hubitat
 */
...
metadata {
	definition (name: 'Spruce Controller', namespace: 'plaidsystems', author: 'Plaid Systems') {
		...
		//new release
        fingerprint endpointId: "01", profileId: "0104", deviceId: "0002", deviceVersion: "00", inClusters: "0000,0003,0004,0005,0006,0009,000A,000F", outClusters: "0003, 0019", manufacturer: "PLAID SYSTEMS", model: "PS-SPRZ16-01"
...
def parse(String description) {	
    ...
    if (map) {
        ...
        if (map.value == 'warning' || map.value == 'alarm'){
            ...
            result = cmds?.collect { new hubitat.device.HubAction(it) } + createEvent(map) + alarmEvt           
			return result
		}
