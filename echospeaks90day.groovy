...
// force defaults
    ...
    if(settings.refreshCookieDays == null) settingUpdate("refreshCookieDays", 90, "number")
    ...
    return dynamicPage(name: "authStatusPage", install: false, nextPage: "mainPage", uninstall: false) {
        if((Boolean)state.authValid) {
            ...
            section(sectHead("Cookie Tools: (Tap to show)", getAppImg("cookie")), hideable: true, hidden: true) {
                ...
                if(refreshCookieDays != null && refreshCookieDays > 90) { settingUpdate("refreshCookieDays", 90, "number") }
...
Integer cookieRefreshSeconds() { return ((Integer)settings.refreshCookieDays ?: 90)*86400 as Integer }
...
String nextCookieRefreshDur() {
    Integer days = (Integer)settings.refreshCookieDays ?: 90
